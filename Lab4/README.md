...
the code from Lab 2 into the control file for AUBIE. Also, the sample instructions contain testing for ALU functions.

This goes the same for the Register File and the DLX Register. You can find
